...
use SphereMall\MS\Lib\Elastic\Filter\Config\CategoriesConfig;
use SphereMall\MS\Lib\Elastic\Filter\Config\EntityGroupsConfig;
...
//        ]);
    ...
    public function testCategories()
    {
        ...
        $filter = new FilterBuilder();
        $filter->setConfigs([
            new CategoriesConfig(true),
            new EntityGroupsConfig(true),
        ]);

        $filter->setParams([
            new CategoriesParams([2], FilterOperators::IN),
        ]);
